# TennisIQ — Complete Technical Handoff v3.3

**Date:** May 7, 2026 (updated from v3.1, May 6, 2026)
**Author:** Robert Song + development session context (Sessions 1-10)
...
6. **Daily refresh of percentile_rankings.json** — currently only refreshed when compute_percentiles.py is run manually. Add to .github/workflows/daily-update.yml after Sackmann pull.
